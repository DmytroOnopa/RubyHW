...
puts '32. Дан целочисленный массив. Вывести индексы массива в том порядке, в котором соответствующие им элементы образуют возрастающую последовательность.'
 a = [1, 52, -6, 49, -99, 27]
 puts "Дан массив #{a}."
 puts  "Порядок, в котором соответствующие им элементы образуют возрастающую последовательность: #{a.map.with_index { |e, i| [e, i] }.sort_by { |e, _i| e }.map { |_e, i| i }}"
p '<————————————————————————————————————————>'
...
puts '37. Дан целочисленный массив. Найти индекс последнего минимального элемента.'
 a = [1, 52, -6, 49, -99, -99]
 puts "Дан массив #{a}."
 puts "Индекс последнего минимального элемента: #{a.map.with_index { |e, i| [e, i] }.sort_by { |e, _i| - e }.map { |_e, i| i }.last}"
p '<————————————————————————————————————————>'
...
puts '38. Дан целочисленный массив. Найти индекс последнего максимального элемента.'
 a = [1, 52, -6, 49, -99, -99]
 puts "Дан массив #{a}."
 puts "Индекс последнего максимального элемента: #{a.map.with_index { |e, i| [e, i] }.sort_by { |e, _i| e }.map { |_e, i| i }.last}"
p '<————————————————————————————————————————>'
...
puts '49. Дан целочисленный массив. Найти количество элементов, расположенных перед первым минимальным.'
 ...
 puts "Дан массив #{a}."
 puts "Кол-во элементов, расположенных перед первым минимальным: #{a.map.with_index { |e, i| [e, i] }.sort_by { |e, _i| e }.map { |_e, i| i }.first}"
p '<————————————————————————————————————————>'
...
puts '50. Дан целочисленный массив. Найти количество элементов, расположенных перед первым максимальным.'
 a = [1, 2, 3, -70, 70, 4, 5, 6, 7, 8]
 puts "Дан массив #{a}."
 puts "Кол-во элементов, расположенных перед первым максимальным: #{a.map.with_index { |e, i| [e, i] }.sort_by { |e, _i| - e }.map { |_e, i| i }.first}"
p '<————————————————————————————————————————>'
...
puts '51. Дан целочисленный массив. Найти количество элементов, расположенных после первого максимального.'
 a = [1, 2, 3, -70, 70, 4, 5, 6, 7, 8]
 puts "Дан массив #{a}."
 puts "Кол-во элементов, расположенных после первого максимального: #{a.length - a.map.with_index { |e, i| [e, i] }.sort_by { |e, _i| - e }.map { |_e, i| i }.first - 1}"
p '<————————————————————————————————————————>'
...
puts '52. Дан целочисленный массив. Найти количество элементов, расположенных после первого минимального.'
 a = [1, 2, 3, -70, 70, 4, 5, 6, 7, 8]
 puts "Дан массив #{a}."
 puts "Кол-во элементов, расположенных после первого минимального: #{a.length - a.map.with_index { |e, i| [e, i] }.sort_by { |e, _i| e }.map { |_e, i| i }.first - 1}"
p '<————————————————————————————————————————>'
...
puts '53. Дан целочисленный массив. Найти количество элементов, расположенных перед последним максимальным.'
 ...
 puts "Дан массив #{a}."
 puts "Кол-во элементов, расположенных перед последним максимальным: #{a.map.with_index { |e, i| [e, i] }.sort_by { |e, _i| e }.map { |_e, i| i }.last}"
p '<————————————————————————————————————————>'
...
puts '54. Дан целочисленный массив. Найти количество элементов, расположенных перед последним минимальным.'
 a = [1, 2, 3, -70, 70, -70, 70, 4, 5, 6, 7, 8]
 puts "Дан массив #{a}."
 puts "Кол-во элементов, расположенных перед последним минимальным: #{a.map.with_index { |e, i| [e, i] }.sort_by { |e, _i| - e }.map { |_e, i| i }.last}"
p '<————————————————————————————————————————>'
...
puts '55. Дан целочисленный массив. Найти количество элементов, расположенных после последнего максимального.'
 a = [1, 2, 3, -70, 70, -70, 70, 4, 5, 6, 7, 8]
 puts "Дан массив #{a}."
 puts "Кол-во элементов, расположенных после последнего максимального: #{a.map.with_index { |e, i| [e, i] }.sort_by { |e, _i| e }.map { |_e, i| i }.first - 1}"
p '<————————————————————————————————————————>'
...
puts '56. Дан целочисленный массив. Найти количество элементов, расположенных после последнего минимального.'
 a = [1, 2, 3, -70, 70, -70, 70, 4, 5, 6, 7, 8]
 puts "Дан массив #{a}."
 puts "Кол-во элементов, расположенных после последнего минимального: #{a.map.with_index { |e, i| [e, i] }.sort_by { |e, _i| - e }.map { |_e, i| i }.first - 1}"
p '<————————————————————————————————————————>'
